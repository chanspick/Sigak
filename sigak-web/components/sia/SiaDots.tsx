 ...
 * - 좌측 정렬, Sia 버블과 동일 배경 (--color-bubble-ai)
...
export function SiaDots() {
  return (
    ...
    >
      <span className="sia-dot h-[5px] w-[5px] rounded-full bg-[var(--color-ink)]/45" />
      <span className="sia-dot sia-dot-2 h-[5px] w-[5px] rounded-full bg-[var(--color-ink)]/45" />
      <span className="sia-dot sia-dot-3 h-[5px] w-[5px] rounded-full bg-[var(--color-ink)]/45" />
    </div>
  );
}
